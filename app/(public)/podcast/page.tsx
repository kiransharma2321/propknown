...
export const metadata: Metadata = {
  title: "Podcast | PropKnown — Real Estate Intelligence",
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-14">
          <div className="inline-flex items-center gap-2 bg-gray-100 border border-gray-200 text-gray-500 text-xs px-4 py-2 rounded-full mb-4">
            <Mic2 size={13} style={{ color: "#C9A24B" }} /> PropKnown Podcast
          </div>
            ...
            <div key={ep.ep} className="bg-white border border-gray-200 rounded-xl p-5 hover:border-yellow-400 hover:shadow-md transition-all group cursor-pointer flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between mb-1">
                  <span className="text-xs font-bold tracking-widest" style={{ color: "#C9A24B" }}>{ep.ep}</span>
