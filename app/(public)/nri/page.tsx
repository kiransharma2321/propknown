...
const CONCIERGE_STEPS = [
  ...
  {
    title: "Virtual Tour",
    desc: "Request a live video walkthrough of any shortlisted property — no need to fly in. Our team walks you through it in real time over video call.",
  },
  {
...
const PROCESS_STEPS = [
  {
    step: "01",
    title: "Brief & Budget",
    desc: "WhatsApp our team with your requirements — location, type, budget in your currency. We confirm realistic options and India pricing.",
  },
  {
    step: "02",
  ...
  },
  {
    ...
    desc: "Video walkthrough by our team. You see the actual property, surroundings, road access, and neighbouring development.",
  },
  {
    step: "04",
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href={`${WA}?text=${encodeURIComponent("Hi Raghu, I'm an NRI interested in investing in property in India. Can you help me?")}`}
              ...
              Talk to an Expert Now — Free NRI Consultation
            </a>
        ...
        <div className="mb-16">
          ...
          <div className="max-w-2xl mx-auto mt-2">
            <a href={`${WA}?text=${encodeURIComponent("Hi Raghu, I'm an NRI going through the remote buying process and have a question about one of the steps.")}`}
              ...
              style={{ background: "#25D366" }}>
              <Phone size={15} /> Talk to an Expert Now
            </a>
        ...
        <div className="rounded-3xl p-10 text-center text-white" style={{ background: "linear-gradient(135deg,var(--navy),#1a2f5c)" }}>
          ...
          <p className="text-gray-300 max-w-lg mx-auto mb-6 text-sm leading-relaxed">
            Our team personally handles all NRI clients. WhatsApp us — available 9am to 9pm IST (UTC+5:30).
