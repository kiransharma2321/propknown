...
export const metadata: Metadata = {
  ...
  description: "Sell your property with PropKnown. AI valuation, professional photography, 5000+ active buyers. Average selling time 30 days. Transparent 1-2% commission.",
};
...
const STEPS = [
  ...
  { step: "03", title: "Buyer Matching",      desc: "5000+ active buyers. We match your property to qualified, pre-vetted prospects." },
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          <div>
            <h2 className="text-gray-900 text-2xl font-bold mb-4" style={{ fontFamily: "var(--font-playfair, Georgia, serif)" }}>
              List Your Property <span className="gold-text">Today</span>
            </h2>
